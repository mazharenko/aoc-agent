Normally, the agent attempts to calculate and submit answers only when all the provided examples have passed. Until examples are given, no attempts are made.
